...
The table with the required data was saved to a CSV file. Then, in **VSCode**, I replaced commas `,` with dots `.`, because Excel in my region saves numbers with a comma as the decimal separator.  
